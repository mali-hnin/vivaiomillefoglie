...
RSpec.describe VivaioEvent, type: :model do
  ...
  describe "Scopes" do
    event1 = VivaioEvent.create(title: "Lorem ipsum", content: nil, data_evento: DateTime.now.beginning_of_day + 2.week, data_fine_evento: DateTime.now.beginning_of_day + 2.week + 36.hours)
    event2 = VivaioEvent.create(title: "Lorem ipsum", content: nil, data_evento: DateTime.now.beginning_of_day - 1.week, data_fine_evento: DateTime.now.beginning_of_day - 1.week + 8.hours)
